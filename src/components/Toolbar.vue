<template>
    <div>
        ...
        <!-- 保存图片弹框-->
        <el-dialog :visible.sync="centerDialogVisible" center title="请输入页面名称" width="30%">
            <el-input v-model="pageName" placeholder="请输入页面名称"></el-input>

            <span slot="footer" class="dialog-footer">
                <el-button @click="centerDialogVisible = false">取 消</el-button>
                <el-button type="primary" @click="handleSavePage">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            pageName: '',
            isShowCompletePage: false,
        }
    },
    computed: mapState(['componentData', 'canvasStyleData', 'areaData', 'curComponent']),
    created() {
